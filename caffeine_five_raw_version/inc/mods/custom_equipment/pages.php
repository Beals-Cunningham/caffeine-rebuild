...
$theprice = $obj["sales_price"];
            ...
            if($theprice != '' && $obj["msrp"] != '') {
                $pricepresent = '<span class="startingat">Starting At:</span><span style="color:red;text-decoration:line-through;"><span class="equipprice" style="color: red; font-size: 1.8rem; padding:5px;">$' . $theprice . '</span></span><br><span class="startingat">Dealer Price:</span><span class="equipprice" style="font-size: 1.8rem; padding:5px;">$' . $obj["msrp"] . '</span>';
                ...
                $pricepresent = '<span class="startingat">Starting At:</span><span class="equipprice" style="font-size: 1.8rem; padding:5px;">$' . $theprice .'</span>';
                $ifcart = '<button class="btn btn-dark save-later" data-eqid="'.$obj["id"].'" data-eqname="'.$obj["title"].'" data-eqtype="custom" data-price="'.$obj["msrp"].'" data-url="'.$actual_link.'"> Add To Cart <i class="fa fa-shopping-cart"></i></button>';
            } else {
                $pricepresent = '';
                $ifcart = '';
