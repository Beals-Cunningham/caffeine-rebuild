...
<label>Your Review</label><br>
            ...
            $html .= '<div class="row" style="padding-top:92px;">';
...
//            }
            ...
            $html .= '<div class="col-md-4"><h1 class="eq_title big-honda-title">' . $tt . '<br><span class="sub-h1">' . $outTitleSub . '</span></h1>' . $bullethtml . '<br><br>' . $msrp . '' . $priceOut . '<br><br> <button class="btn btn-danger parts-button neweqreq" data-toggle="modal" data-target="#myModalEq">Request a Quote</button> ' . $saveButton . '<br><br>
<!-- AddToAny BEGIN -->
...
<!-- AddToAny END --><br><br><div style="font-size:30px">' . $starsNow . ' <br>' . $readRevs . ' <a style="font-size: 12px" href="javascript:void(0)" class="reviewit" data-neweqids="' . $obj["id"] . '"></a></div><br><br>' . $optLinksOut . '<br><br><div class="offer-titles-set"></div></div>';
            ...
            $html .= '<div class="container-fluid spec-contain">';
...
//            }
            ...
            <div class="honda" style="margin-bottom: 20px; border: transparent;">
                <div class="product-image" style="background-repeat: no-repeat; background-position: center; background-position: center; background-size: contain;">
                    <a href="'.$_SERVER['REQUEST_URI'].'/'.$d["page_name"].'">
                       <img class="pic-1 img-responsive" src="'.$d["cat_img"].'">
                    </a>
                </div>           
                <div class="product-content" style="padding: 20px">
                    <h3 class="title" style="font-size: 1.3rem; text-align: center;background: #CC0000; padding:5px;"><a style="color: #fff;" href="'.$_SERVER['REQUEST_URI'].'/'.$d["page_name"].'">'.str_replace('-',' ',$d["page_name"]).'</a></h3>
...
//                                }
            ...
            <div class="honda" style="border: transparent;">
                <div class="product-image" style="background-image: url(../img/Honda/' . $mainImage . '); background-repeat: no-repeat; background-position: center; background-size: contain;">
                ...
                <div class="product-content" style="border: transparent;">
                    <h3 class="title" style="margin-bottom: 0; background: #CC0000; color: #fff; padding:5px; font-size: 20px;"><a style="color: #fff; padding-left: 20px;"href="' . $_SERVER['REQUEST_URI'] . '/' . $f["title"] . '">' . str_replace('-', ' ',$f["title"]) . '</a></h3>
