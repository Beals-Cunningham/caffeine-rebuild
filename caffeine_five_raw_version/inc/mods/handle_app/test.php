...
<script>
    ...
    function Auth() {
        ...
        xhttp.open("POST", "https://smithtractorco.com/Services/Portal/Security/10/MyAuthenticationService.svc", true);
    ...
    function loadDoc(value) {
        ...
        xhttp.open("POST", "https://smithtractorco.com/Services/Crm/Notes/10/EntityCreateHandler.ashx", true);
