...
class machineFind{
    function runOutput(){
        ...
        /*$html .= '<div class="searchbarhold">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex">
                                    <input class="form-control col serbox" type="text" name="usedser" id="usedser" placeholder="Search categories, models or keywords" value="'.$serset.'" style="margin: 0 2px;">
                                    <div class="btn-group special" style="margin: 0 2px;" role="group" aria-label="Basic example">
                                        <button type="button" class="btn btn-secondary px-3 listtypout '.$girdvw.'" data-listtype="grid" style="background: #000; color: #FAB906; margin-right: 4px;"><i class="fas fa-th-large"></i></button>
                                        <button type="button" class="btn btn-secondary px-3 listtypout '.$listvw.'" data-listtype="list" style="background: #000; color: #FAB906; margin-right: 4px;"><i class="fas fa-list"></i></button>
                                        <a href="Used-Equipment" type="button" class="btn btn-warning px-3" style="background: #185733; color: #FAB906; padding-top:14px; padding-bottom:14px;"><i class="fas fa-times"></i> RESET</a>
                                    </div>
                                </div>
                                <div class="tags" style="margin-top: 5px">'.$tabs.'</div>
                            </div>';*/
        $html .= '<div class="searchbarhold">
                    <div class="container">
                        <div class="row">
...
<div class="btn-group" role="group" aria-label="Basic example">
  ...
  <button style="padding: 14px;font-weight: 500; width: 100%; text-align: left;
...
<a class="dropdown-item sorters" href="javascript:void(0)" data-dorttype="recent">Recent</a><a class="dropdown-item sorters" href="javascript:void(0)" data-dorttype="mod-a-z">Model A-Z</a><a class="dropdown-item sorters" href="javascript:void(0)" data-dorttype="mod-z-a">Model Z-A</a><a class="dropdown-item sorters" href="javascript:void(0)" data-dorttype="price-low-high">Price Low-High</a><a class="dropdown-item sorters" href="javascript:void(0)" data-dorttype="price-high-low">Price High-Low</a><a class="dropdown-item sorters" href="javascript:void(0)" data-dorttype="hours-low-high">Hours Low-High</a><a class="dropdown-item sorters" href="javascript:void(0)" data-dorttype="hours-high-low">Hours High-Low</a><a class="dropdown-item sorters" href="javascript:void(0)" data-dorttype="year-new-old">Year New-Old</a><a class="dropdown-item sorters" href="javascript:void(0)" data-dorttype="year-old-new">Year Old-New</a><a class="dropdown-item sorters" href="javascript:void(0)" data-dorttype="man-a-z">Manufacturer A-Z</a><a class="dropdown-item sorters" href="javascript:void(0)" data-dorttype="man-z-a">Manufacturer Z-A</a><a class="dropdown-item sorters" href="javascript:void(0)" data-dorttype="cat-a-z">Category A-Z</a><a class="dropdown-item sorters" href="javascript:void(0)" data-dorttype="cat-z-a">Category Z-A</a>
    ...
    overflow: scroll;">';
            ...
            if($f["city"] != '') {
                ...
                if(isset($_REQUEST["locations"])){
                    ...
                    if(in_array($f["city"],$locOuts)){
                        $html .= '<button class="btn locbutt-active" data-loca="'.$f["city"].'" style="text-transform:uppercase">' . $f["city"] . '</button>';
                    }else{
                        $html .= '<button class="btn locbutt" data-loca="'.$f["city"].'" style="text-transform:uppercase">' . $f["city"] . '</button>';
                    }
                }else{
                    $html .= '<button class="btn locbutt" data-loca="'.$f["city"].'" style="text-transform:uppercase">' . $f["city"] . '</button>';
                }
        ...
        $html .= '<div class="col-6" style="text-align: right; color: #000; font-weight: bold"><span id="stryear">1900</span> - <span id="endyear">2021</span></div>';
        ...
        $html .= '<div class="col-6" style="text-align: right; color: #000; font-weight: bold"><span id="strprice">0</span> - <span id="endprice">90000+</span></div>';
        ...
        $html .= '<div class="col-6" style="text-align: right; color: #000; font-weight: bold"><span id="strhour">0</span> - <span id="endhour">5000+</span></div>';
    ...
    overflow: scroll;">';
        ...
        $html .= '<div class="lds-ring"><div></div></div></div></div></div></div>';
    ...
    <style>
        ...
        $html .= '<div class="container-fluid pt-3"><div class="col-12"><hr style="height: 2px; background: #000"></div></div>';
        $html .= '<div class="container-fluid used-top-home" style="min-height:240px;"></div>';
        $html .= '<div class="container-fluid used-bottpm-home">';
        $html .= '<div class="col-12 pb-5 useditems">';
