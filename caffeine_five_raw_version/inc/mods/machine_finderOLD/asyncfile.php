...
if($act == 'getresults'){
    ...
    $html .= '<div class="col-md-4"><h1 class="page-title">Used Equipment</h1><br><div class="btn-group">
  <button type="button" class="btn btn-success show-sort">'.$sorterset.'</button>
  <button type="button" class="btn btn-success dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    <span class="sr-only">Toggle Dropdown</span>
  </button>
  <div class="dropdown-menu dropdown-menu-class">
...
////FOR TRUE SEARCH ENGINE RUN THIS ON DB COLUMNS ALTER TABLE used_equipment ADD FULLTEXT(columnnamehere);
    ...
    while($b = $a->fetch_assoc()) {
        ...
        $html .= '<div class="col-md-4 col-lg-3 col-sm-6">
            <div class="product-grid" style="max-height: 200px; min-height: 300px; box-shadow: 1px 2px 4px #949292; margin-bottom: 20px">
                <div class="product-image">
