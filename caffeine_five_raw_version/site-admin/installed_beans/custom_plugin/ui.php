...
<?php }else{ ///SHOW LIST VIEW ?>
    ...
    <div class="header">
        ...
        <div class="col-md-6" style="text-align: right">
            <?php echo $pageButton; ?>
            <button class="btn btn-warning mod-prods" style="margin: 20px;color: #fff; min-width:200px;">Manage Products</button> <a href="?createnew=true" class="btn btn-success btn-fill" style="margin: 20px;min-width:200px;">Create New Category</a><button class="btn btn-primary" style="float:right; margin: 20px; background: #007bff; color: #fff; min-width:200px;" onclick="location.href='index-export.php'" >Import/Export Data</button>
        </div>
        </div>
        <div class="clearfix"></div>
    </div>
