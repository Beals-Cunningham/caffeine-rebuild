...
if ($act == 'readjob') {
    ...
    $html .= '<button onclick="myFunction()" style="margin: 0 10px; width: 100px; color: white" class="btn btn-success"><i class="fas fa-share-square" style="color: white"></i> Share</button> <span id="link-copied" class="alert alert-success alert-dismissible" style="display:none;padding: 6px;">Link Copied</span>
                <script>
                    function myFunction() {
                        /* Get the text field */
                        var copyText = "https://sunsouth.com/careers?jobid='.$_REQUEST["id"].'";
                  
                        /* Copy the text inside the text field */
                        navigator.clipboard.writeText(copyText).then(() => {
                            document.getElementById("link-copied").style.display = "inline-block";
                        }).catch(() => {
    ...
    // $html .= '<div style="height: 30px"></div>';
    $html .= '<div class="panel panel-success"> <div class="panel-heading" style="background:#457442"><h3 class="panel-title" style="background:#457442; color: white; padding: 0px 20px;">Qualifications</h3> </div> <div class="panel-body">' . $b["qualifications"];

    if($b["applyLink"] != ""){
        $html.='<a class="btn btn-success" href="'.$b["applyLink"].'" target="_blank" rel="noopener">Apply</a>';
    }
