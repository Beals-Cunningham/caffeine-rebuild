...
class deereClass
{
    ...
    function getProduct($prod, $cat)
    {
        ...
        $a = $data->query("SELECT id, title, sub_title, price, dealer_price, eq_image, offers_active, videos_active, access_active, reviews_active, extra_content, cta_text FROM deere_equipment WHERE title = '$prod'");
        $b = $a->fetch_array();
