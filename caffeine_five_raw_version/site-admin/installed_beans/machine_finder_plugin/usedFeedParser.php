...
//echo $image;
        ...
        function dataManagment($machines, $timeNow)
        {
            ...
            for ($x = 0; $x <= count($machines); $x++) {
                ...
                if(in_array("bale_count", $machines[$x]['meters']["meter"])) {

                    $bale_count = $machines[$x]['meters']["meter"]["value"];
                }
                ...
                $bale_countOut = $data->real_escape_string($bale_count);
