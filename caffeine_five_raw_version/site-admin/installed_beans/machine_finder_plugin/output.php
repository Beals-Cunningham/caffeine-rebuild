...
<div class="row" style="padding: 10px; margin: 0">
    ...
    <div class="col-md-3 mob-sensor">
        ...
        <!--start filters -->
        <br><br>
        <div style="text-align: right"><button class="btn btn-success btn-xs" style="font-size: 12px" onclick="resetFilters()"><i class="fa fa-times-circle"></i> Reset All Filters</button></div>
        <br>
