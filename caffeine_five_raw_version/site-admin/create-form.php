                        ...
                        <div class="card-box" style="margin-top:20px">
                            ...
                            <div style="padding: 20px">
                                ...
                                <div class="formbuilder row">
                                    ...
                                    <div class="col-md-12" style="padding: 20px">
                                        <label>Reply Message</label><br><small>With this turned on it will send a reply email to the user if a email field is present in form. (NOTE! Must name the field email) </small><br>
                                        <input type="checkbox" name="replyset" id="replyset" value="false"><br><br>
                                        <div class="replybox" style="display: none">
                                        <textarea name="respmess" id="respmess" class="summernote"><div style="padding: 20px;"><h2>Thank You!</h2><p>We have received your message and will be getting back with you A.S.A.P.</p></div></textarea>
                                        </div>
                                    </div>
