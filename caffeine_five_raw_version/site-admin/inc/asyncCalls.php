...
if($act == 'updatedgapikeys'){
    $site->updategapikey($_POST);
    echo 'SET';
}
...
if($act == 'createbackup'){
    ...
    if($type == 'sitestyles'){
        copy("../../css/styles.css","../../inc/backups/site-".date('m-d-Y His').".css");
        echo '<i class="fa fa-floppy-o" aria-hidden="true"></i> &nbsp; &nbsp; CSS Backup Created Successfully!';
    }
