...
//RUN INSTALL QUERIES//
    ...
    $data->query("INSERT INTO beans_dep SET file = 'inc/mods/career_plugin/js/career_functions.js', bean_id = '$last_id', type = 'js', headload = 'true', load_type = 'mod', active = 'true'");
    $data->query("INSERT INTO beans_dep SET file = 'inc/mods/career_plugin/js/jquery.paginate.js', bean_id = '$last_id', type = 'js', headload = 'true', load_type = 'mod', active = 'true'");
    $data->query("INSERT INTO beans_dep SET file = 'inc/mods/career_plugin/css/jquery.paginate.css', bean_id = '$last_id', type = 'css', headload = 'true', load_type = 'mod', active = 'true'");
    $data->query("INSERT INTO beans_dep SET file = 'inc/mods/career_plugin/css/main.css', bean_id = '$last_id', type = 'css', headload = 'true', load_type = 'mod', active = 'true'");
