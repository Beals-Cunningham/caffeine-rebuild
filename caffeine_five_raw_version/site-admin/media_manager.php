...
function createThumbnail($filepath, $thumbpath, $thumbnail_width, $thumbnail_height, $background=false) {
    ...
    $new_height = floor($original_height * ($thumbnail_width / $original_width));
...
//    $dest_y = intval(($thumbnail_height - $new_height) / 2);
    ...
    $new_image = imagecreatetruecolor($thumbnail_width, $new_height); // creates new image, but with a black background
    ...
    imagecopyresampled($new_image, $old_image, 0, 0, 0, 0, $thumbnail_width, $new_height, $original_width, $original_height);
